...
<template>
  <div
    class="relative flex items-top justify-center min-h-screen bg-gray-100 sm:items-center sm:pt-0 wrap"
  >
    <link
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
        ...
        <p class="mt-3 text-gray-600">
          <span class="font-medium">Access Token</span> : {{ accessToken }}
        </p>
        <p class="mt-3 text-gray-600">
          <span class="font-medium">Refresh Token</span> : {{ refreshToken }}
        </p>
        ...
        <button
          class="px-4 py-2 bg-gray-700 text-white rounded-lg mt-4"
          @click="request"
        >
          Request
        </button>
...
export default {
  ...
  methods: {
    async request() {
      let res = await this.$axios.get("/auth/private");
    },
  },
  computed: {
    ...mapState("auth", {
